...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <form action="{{ url('/nisan/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="blok_nomor_nisan" required>
                            </div>
                            <div class="form-group">
                                <label>Nama:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="gereja" required>
                            </div>
                            <div class="form-group">
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_nomor_keluarga" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="tanggal_iuran">
                                <input type="text" class="form-control" name="pembayaran_terakhir" required />
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-th"></span>
                                </span>
                            </div>
